...
$GLOBALS['TL_LANG']['MSC']['tl_backupdb']['ws_template_module']  = 'The following extensions must be installed:';
...
$GLOBALS['TL_LANG']['MSC']['tl_backupdb']['ws_template_anl20']   = '2. Installation of all listed extensions.';
